...
All interest paid by borrowers accrues directly to liquidity providers (Byzantine Prime depositors) through audited smart contracts. Returns compound automatically and transparently, without trading, leverage, or speculative exposure.

In short: Returns come from lending, not from market bets. Borrowers pay interest for access to liquidity, and Byzantine Prime depositors earn that interest as returns, fully collateralised, programmatically managed, and continuously distributed on-chain.