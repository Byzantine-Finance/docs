...
- Un market maker détenant une grande position en actifs numériques qui a besoin de liquidités USDC à court terme pour honorer une obligation - il ne veut pas vendre sa position, il emprunte donc dessus
...
Byzantine Prime n'opère que dans des marchés utilisant des collatéraux de haute qualité et très liquides. La sélection des collatéraux fait partie du mandat d'investissement de Keyrock - les marchés utilisant des collatéraux de faible qualité ou peu liquides ne sont jamais sélectionnés, quel que soit le rendement qu'ils proposent. Les types de collatéraux acceptés dans chaque marché sont choisis pour garantir une profondeur de marché suffisante pour absorber de grandes ventes même en période de stress, et pour rester gérables dans le cadre de ratios de collatéral conservateurs.
