...
The user must accept the [Byzantine Terms and Conditions](https://www.byzantine.fi/terms-and-conditions) before creating the user account. The `timestamp` of the acceptance is required in the `/submit/create-entity` endpoint.
