...
Beyond raw request signing, the SDK exposes methods that wrap Byzantine API endpoints. Use these for a consistent, typed interface to vault data, accounts, deposits, withdrawals, and user management without building request URLs and bodies by hand. Refer to the [OpenAPI specification](/api-reference/openapi-integrator.json) and the SDK’s exported types for the full list of supported operations.
