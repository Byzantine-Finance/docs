...
| **What you can do**                 |                                                                                      |
| ----------------------------------- | ------------------------------------------------------------------------------------ |
| **[Create and Manage Accounts](/api-reference/kyc)**      | Programmatically create user accounts, fetch balances, and track user portfolios.    |
| **[Handle Deposits and Withdrawals](/api-reference/deposit)** | Submit and reconcile transactions securely through a unified workflow.               |
| **[Access User Data](/api-reference/query-user-data/get-all-deposits-by-user-id)**                | Retrieve user-specific performance, transaction history, and positions in real time. |
| **[Retrieve Vault Data](/api-reference/query-vault-data/get-vault-apy)**             | Access live information on vaults, supported assets, strategies, and yields.         |
