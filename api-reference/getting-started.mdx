...
Access to the Byzantine API requires an **Integrator API Key**.\
Get in touch to learn more about integrating Byzantine — we’ll verify your use case and generate your key manually.

<Card title="Get in touch" icon="sparkles" horizontal href="mailto:info@byzantine.fi" cta="Testing123">
