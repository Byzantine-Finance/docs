...
| **[Access Account and User Data](/api-reference/account-data/get-user-details-by-user-id)**                | Retrieve user-specific performance, transaction history, and positions in real time. |
| **[Retrieve Vault Data](/api-reference/vault-data/get-vault-apy)**             | Access live information on vaults, supported assets, strategies, and yields.         |
