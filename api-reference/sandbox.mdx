...
<Card
  ...
  icon="plus"
  horizontal
  href="https://www.postman.com/byzantine-finance/byzantine-api/collection/49853283-e200d04f-7fbf-4dc5-ad51-df78aa4b4182"
></Card>

If you would rather not leave the browser, every endpoint page in this reference has an interactive playground built in. Activate your sandbox integrator key once on the page below and the **Send** button signs each request for you, so you can try any endpoint without setting up a client.

<Card
  title="Sandbox authentication"
  icon="play"
  horizontal
  href="/api-reference/sandbox-auth"
></Card>

## Accessing the Sandbox

Use the sandbox environment to test your integration and try API request/response schemas.
