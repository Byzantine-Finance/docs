...
<Tabs>
  <Tab title="OTP">
    ...
    1. [Get approval transaction](https://docs.byzantine.fi/api-reference/transactions-with-otp/initiate-approval), which sends an OTP code to user's email address.
