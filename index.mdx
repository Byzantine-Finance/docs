...
<Columns cols={2}>
  ...
  <Card icon="lock" href="documentation/asset-protection/security-mechanisms" title="Security">
    Learn about our security mechanisms.
  </Card>
  <Card icon="forward" href="documentation/about-byzantine/the-digital-asset-opportunity" title="The digital asset opportunity">
    Explore the next generation of finance.
  </Card>
  <Card icon="terminal" href="/api-reference/getting-started" title="API documentation">
