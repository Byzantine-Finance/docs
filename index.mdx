...
<Columns cols={2}>
  <Card
    title="FAQ"
    icon="question"
    href="faq/what-is-byzantine-prime-at-a-glance"
  >
  ...
  <Card
    title="Security"
    icon="lock"
    href="documentation/asset-protection/security-mechanisms"
  >
    ...
    icon="forward"
    href="documentation/about-byzantine/the-digital-asset-opportunity"
  >
