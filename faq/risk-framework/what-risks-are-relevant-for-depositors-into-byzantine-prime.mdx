...
<AccordionGroup>
  ...
  <Accordion title="Byzantine counterparty risk">
    ...
    Byzantine has the ability to change the strategy curator(Keyrock), but this is subject to a lengthy timelock - a period during which Byzantine and third-party monitors can veto this change, or, in the worst case, during which clients have ample time to withdraw their assets.
  </Accordion>
