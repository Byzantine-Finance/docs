...
<AccordionGroup>
  <Accordion title="Smart contract risk">
    ...
    Finally, users can opt into optional insurance to protect against any kind of smart contract failure. **This insurance policy is the ultimate recourse against any code-related loss.**
  </Accordion>
  ...
  <Accordion title="Custody risk">
    ...
    Compromise of keys or unauthorised access to user accounts.
