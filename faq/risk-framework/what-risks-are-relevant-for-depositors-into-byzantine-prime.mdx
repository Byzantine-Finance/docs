...
[PreviousWhat exactly is Keyrock’s mandate?](/documentation/introduction/faq/risk-framework/what-exactly-is-keyrocks-mandate)[NextWhat is my counterparty risk towards the borrower?](/documentation/introduction/faq/risk-framework/what-is-my-counterparty-risk-towards-the-borrower)
