...
- You can **use your own account**, link it through an available account platform and sign the message.
- Or **create a new, self-custodial account** that is fully encrypted and accessible only via passkey linked to your device.
