...
Byzantine Finance SAS acts solely as a technical service provider, offering the software and interfaces enabling clients to access regulated counterparties and on-chain strategies. Byzantine does not hold, control, or intermediate client assets, nor does it execute transactions on behalf of users.
