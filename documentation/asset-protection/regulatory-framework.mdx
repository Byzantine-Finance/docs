...
- **Keyrock Curation Services**, a registered Digital Asset Service Provider (DASP), assesses the smart contract vault risk and sets the deployment strategy.
...
Users retain full and continuous control over their funds through self-custodial accounts. At no point can Byzantine or any third party access, move, or otherwise control user assets without explicit authorisation through the user’s own account signature.
